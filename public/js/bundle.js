...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../../clients/httpClient.js":[function(require,module,exports) {
...
function _get() {
  _get = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, jwtCookie) {
...
function _post() {
  _post = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url, data, jwtCookie) {
    var requestObject, response;
...
function deleteMethod(_x6, _x7) {
  return _deleteMethod.apply(this, arguments);
}

function _deleteMethod() {
  _deleteMethod = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(url, jwtCookie) {
    var requestObject, response;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "".concat(undefined ? undefined : 'http://127.0.0.1:8000', "/api/v1/users/login");
            _context.next = 4;
            return (0, _httpClient.post)(url, {
              email: email,
              password: password
            });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "".concat(undefined ? undefined : 'http://127.0.0.1:8000', "/api/v1/users/logout");
            _context2.next = 4;
            return (0, _httpClient.get)(url);
...
},{"../../clients/httpClient":"../../clients/httpClient.js","./alerts":"alerts.js"}],"signup.js":[function(require,module,exports) {
var define;
"use strict";
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password, name) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "".concat(undefined ? undefined : 'http://127.0.0.1:8000', "/api/v1/users/signup");
            _context.next = 4;
            return (0, _httpClient.post)(url, {
              email: email,
              password: password,
...
},{"../../clients/httpClient":"../../clients/httpClient.js","./alerts":"alerts.js"}],"addMovie.js":[function(require,module,exports) {
var define;
"use strict";
...
var addMovie = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(title, description) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "".concat(undefined ? undefined : 'http://127.0.0.1:8000', "/api/v1/movies");
            _context.next = 4;
            return (0, _httpClient.post)(url, {
              title: title,
          ...
          case 4:
            ...
            if (res.status === 'success') {
              (0, _alerts.showAlert)('success', 'Added movie successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"../../clients/httpClient":"../../clients/httpClient.js","./alerts":"alerts.js"}],"vote.js":[function(require,module,exports) {
var define;
"use strict";
...
exports.vote = exports.deleteVote = void 0;
...
var vote = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var movieId, rating, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            movieId = _ref.movieId, rating = _ref.rating;
            _context.prev = 1;
            url = "".concat(undefined ? undefined : 'http://127.0.0.1:8000', "/api/v1/votes/movie/").concat(movieId);
            _context.next = 5;
            return (0, _httpClient.post)(url, {
              rating: rating
            });
          ...
          case 5:
            ...
            if (res.status === 'success') {
              (0, _alerts.showAlert)('success', 'Voted successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var deleteVote = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "".concat(undefined ? undefined : 'http://127.0.0.1:8000', "/api/v1/votes/").concat(voteId);
            _context2.next = 4;
            return (0, _httpClient.deleteMethod)(url);

          case 4:
            res = _context2.sent;

            if (res.status === 'success') {
              (0, _alerts.showAlert)('success', 'Vote deleted successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function deleteVote(_x2) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deleteVote = deleteVote;
},{"../../clients/httpClient":"../../clients/httpClient.js","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var addMovieForm = document.querySelector('.form--addmovie');
var logOutBtn = document.querySelector('.nav__el--logout');
var likeBtns = document.querySelectorAll('.like--btn');
var hateBtns = document.querySelectorAll('.hate--btn');
var deleteVoteBtns = document.querySelectorAll('.delete-vote--btn');
if (likeBtns) likeBtns.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var likeObject = JSON.parse(e.target.dataset.voteObject);
    (0, _vote.vote)({
      movieId: likeObject.movieId,
      rating: likeObject.rating
    });
  });
});
if (hateBtns) hateBtns.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var likeObject = JSON.parse(e.target.dataset.voteObject);
    (0, _vote.vote)({
      movieId: likeObject.movieId,
...
if (deleteVoteBtns) deleteVoteBtns.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var voteId = e.target.dataset.voteid;
    (0, _vote.deleteVote)(voteId);
  });
});
